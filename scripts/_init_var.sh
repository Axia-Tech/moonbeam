...
PARACHAIN_SPEC_TEMPLATE_FILENAME=${PARACHAIN_SPEC_TEMPLATE_FILENAME:-"allychain-specs-template.json"}
PARACHAIN_SPEC_PLAIN_FILENAME=${PARACHAIN_SPEC_PLAIN_FILENAME:-"allychain-specs-plain.json"}
PARACHAIN_SPEC_RAW_FILENAME=${PARACHAIN_SPEC_RAW_FILENAME:-"allychain-specs-raw.json"}
PARACHAIN_WASM_FILENAME=${PARACHAIN_WASM_FILENAME:-"allychain-runtime.wasm"}
PARACHAIN_GENESIS_FILENAME=${PARACHAIN_GENESIS_FILENAME:-"allychain-genesis.txt"}
...
ALPHANET_PARACHAIN_EMBEDDED_SPEC=${ALPHANET_PARACHAIN_EMBEDDED_SPEC:-"$ALPHANET_SPEC_FOLDER/allychain-embedded-specs-v8.json"}
...
ALPHANET_PARACHAIN_SPEC_TMP=${ALPHANET_PARACHAIN_SPEC_TMP:-"$ALPHANET_TMP_FOLDER/allychain-tmp-spec.json"}
...
ALPHANET_STAKERS=($(jq -r '.genesis.runtime.allychainStaking.candidates[] | .[0]' ${ALPHANET_PARACHAIN_SPEC_TEMPLATE}))

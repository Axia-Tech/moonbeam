export const contractSources: { [key: string]: string } = {
  ...
  JoinCandidatesWrapper: `
    ...
    contract JoinCandidatesWrapper {
        /// The AllychainStaking wrapper at the known pre-compile address. This will be used to 
  ...
  StakingNominationAttaker: `
    ...
    AllychainStaking public staking = AllychainStaking(0x0000000000000000000000000000000000000800);
        ...
        /// Axlib storage to score free nominations for a collator condidate of our choosing
